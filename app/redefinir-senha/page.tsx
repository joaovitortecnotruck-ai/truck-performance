  ...
  return (
    <div className="grid min-h-screen grid-cols-1 lg:grid-cols-[1fr_440px]">
      ...
      <div className="flex flex-col justify-center bg-base-900 px-8 py-12 sm:px-14">
        ...
        <h1 className="font-display text-2xl font-semibold text-ink-100">Nova senha</h1>
        <p className="mt-1 text-sm text-ink-500">Escolha uma nova senha para sua conta.</p>
